...
export default function Home() {
  return (
    <main className="flex flex-col">
      ...
      <br />
      <Link href="./week-7">Week-7 CPRG306 Assignment</Link>
      <br />
      <Link href="./week-8">Week-8 CPRG306 Assignment</Link>
      <br />
      <Link href="./week-9">Week-9 CPRG306 Assignment</Link>
      <br />
      <Link href="./week-10">Week-10 CPRG306 Assignment</Link>
      <br />
    </main>
  );
}
