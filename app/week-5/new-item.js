    ...
    <main className="flex justify-center items-center">
        ...
        <div className='text-black'>
            <form onSubmit={handleSubmit}>
                ...
                <button type='button' className="font-bold rounded-[10px] bg-red-600 text-black px-4 py-2 hover:bg-[#660000] disabled: bg-gray" onClick={decrementQuantity} disabled={quantity == 1}>-</button>
                <span className="text-2xl font-bold text-black border p-2 rounded-[10px] w-12 text-center">{quantity}</span>
                <button type="button" className="font-bold rounded-[10px] bg-green-600 text-black px-4 py-2 hover:bg-[#006400] disabled: bg-gray" onClick={incrementQuantity} disabled={quantity == 20}>+</button>
            </div>
